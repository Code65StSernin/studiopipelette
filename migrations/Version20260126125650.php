 ...
 */
final class Version20260126125650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sous_categorie_vente ADD sous_categorie_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE sous_categorie_vente ADD CONSTRAINT FK_B1838AF0365BF48 FOREIGN KEY (sous_categorie_id) REFERENCES sous_categorie (id)');
        $this->addSql('CREATE INDEX IDX_B1838AF0365BF48 ON sous_categorie_vente (sous_categorie_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sous_categorie_vente DROP FOREIGN KEY FK_B1838AF0365BF48');
        $this->addSql('DROP INDEX IDX_B1838AF0365BF48 ON sous_categorie_vente');
        $this->addSql('ALTER TABLE sous_categorie_vente DROP sous_categorie_id');

 ...
 */
final class Version20260130133835 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE societe ADD fidelite_active TINYINT DEFAULT 0 NOT NULL, ADD fidelite_mode VARCHAR(20) DEFAULT \'visits\' NOT NULL, ADD fidelite_visits_x INT DEFAULT NULL, ADD fidelite_visits_y DOUBLE PRECISION DEFAULT NULL, ADD fidelite_points_x DOUBLE PRECISION DEFAULT NULL, ADD fidelite_points_y DOUBLE PRECISION DEFAULT NULL, ADD fidelite_points_z DOUBLE PRECISION DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD fidelite_cagnotte DOUBLE PRECISION DEFAULT 0 NOT NULL, ADD fidelite_points DOUBLE PRECISION DEFAULT 0 NOT NULL, ADD fidelite_visits INT DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE societe DROP fidelite_active, DROP fidelite_mode, DROP fidelite_visits_x, DROP fidelite_visits_y, DROP fidelite_points_x, DROP fidelite_points_y, DROP fidelite_points_z');
        ...
        $this->addSql('ALTER TABLE user DROP fidelite_cagnotte, DROP fidelite_points, DROP fidelite_visits');

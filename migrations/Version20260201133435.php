 ...
 */
final class Version20260201133435 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture ADD vente_id INT DEFAULT NULL, CHANGE order_id order_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture DROP vente_id, CHANGE order_id order_id INT NOT NULL');

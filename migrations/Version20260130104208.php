 ...
 */
final class Version20260130104208 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bon_achat (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(20) DEFAULT NULL, montant_initial NUMERIC(10, 2) NOT NULL, montant_restant NUMERIC(10, 2) NOT NULL, date_creation DATETIME NOT NULL, date_expiration DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');

 ...
 */
final class Version20260126151248 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE depot_vente (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, commission INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE depot_vente_categorie (depot_vente_id INT NOT NULL, categorie_id INT NOT NULL, INDEX IDX_3546A4ADFADC9094 (depot_vente_id), INDEX IDX_3546A4ADBCF5E72D (categorie_id), PRIMARY KEY (depot_vente_id, categorie_id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE depot_vente_categorie ADD CONSTRAINT FK_3546A4ADFADC9094 FOREIGN KEY (depot_vente_id) REFERENCES depot_vente (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE depot_vente_categorie ADD CONSTRAINT FK_3546A4ADBCF5E72D FOREIGN KEY (categorie_id) REFERENCES categorie (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE user ADD depot_vente_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_8D93D649FADC9094 ON user (depot_vente_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE depot_vente_categorie DROP FOREIGN KEY FK_3546A4ADFADC9094');
        $this->addSql('ALTER TABLE depot_vente_categorie DROP FOREIGN KEY FK_3546A4ADBCF5E72D');
        $this->addSql('DROP TABLE depot_vente');
        $this->addSql('DROP TABLE depot_vente_categorie');
        ...
        $this->addSql('DROP INDEX IDX_8D93D649FADC9094 ON user');
        $this->addSql('ALTER TABLE user DROP depot_vente_id');

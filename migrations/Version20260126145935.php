 ...
 */
final class Version20260126145935 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD gencod VARCHAR(13) DEFAULT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_23A0E66CC33411C ON article (gencod)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_23A0E66CC33411C ON article');
        $this->addSql('ALTER TABLE article DROP gencod');

 ...
 */
final class Version20251214113825 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` CHANGE stripe_checkout_session_id stripe_checkout_session_id VARCHAR(191) DEFAULT NULL, CHANGE stripe_payment_intent_id stripe_payment_intent_id VARCHAR(191) DEFAULT NULL');
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F5299398A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_F52993985A18FBC7 ON `order` (stripe_checkout_session_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_F52993985A18FBC7 ON `order`');
        $this->addSql('ALTER TABLE `order` CHANGE stripe_checkout_session_id stripe_checkout_session_id VARCHAR(255) DEFAULT NULL, CHANGE stripe_payment_intent_id stripe_payment_intent_id VARCHAR(255) DEFAULT NULL');

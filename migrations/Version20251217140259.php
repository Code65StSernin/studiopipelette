 ...
 */
final class Version20251217140259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // La table "offre" peut déjà exister si une précédente exécution partielle de la migration a réussi.
        // On utilise IF NOT EXISTS pour éviter l'erreur "table already exists" lors d'une ré-exécution.
        $this->addSql('CREATE TABLE IF NOT EXISTS offre (id INT AUTO_INCREMENT NOT NULL, petit_texte VARCHAR(255) DEFAULT NULL, grand_texte VARCHAR(255) NOT NULL, texte_bouton VARCHAR(255) DEFAULT NULL, lien_bouton VARCHAR(255) DEFAULT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, image_gauche TINYINT NOT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE address ADD CONSTRAINT FK_D4E6F81A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        // Utiliser un index partiel sur slug pour éviter l erreur MySQL "clé trop longue"
        $this->addSql('ALTER TABLE article DROP INDEX UNIQ_ARTICLE_SLUG, ADD UNIQUE INDEX UNIQ_23A0E66989D9B62 (slug(191))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP INDEX UNIQ_23A0E66989D9B62, ADD UNIQUE INDEX UNIQ_ARTICLE_SLUG (slug(191))');

 ...
 */
final class Version20260121135958 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE depenses ADD remboursement_anticipe TINYINT NOT NULL');
        ...
        $this->addSql('ALTER TABLE societe ADD total_site DOUBLE PRECISION DEFAULT NULL, ADD pourcentage_mensuel DOUBLE PRECISION DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE depenses DROP remboursement_anticipe');
        ...
        $this->addSql('ALTER TABLE societe DROP total_site, DROP pourcentage_mensuel');

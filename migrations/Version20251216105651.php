 ...
 */
final class Version20251216105651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD mondial_relay_recipient_first_name VARCHAR(50) DEFAULT NULL, ADD mondial_relay_recipient_last_name VARCHAR(50) DEFAULT NULL, ADD mondial_relay_parcels_count INT DEFAULT NULL, ADD mondial_relay_content_value_cents INT DEFAULT NULL, ADD mondial_relay_content_description VARCHAR(255) DEFAULT NULL, ADD mondial_relay_length_cm INT DEFAULT NULL, ADD mondial_relay_width_cm INT DEFAULT NULL, ADD mondial_relay_height_cm INT DEFAULT NULL, ADD mondial_relay_shipment_number VARCHAR(100) DEFAULT NULL, ADD mondial_relay_label_url VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP mondial_relay_recipient_first_name, DROP mondial_relay_recipient_last_name, DROP mondial_relay_parcels_count, DROP mondial_relay_content_value_cents, DROP mondial_relay_content_description, DROP mondial_relay_length_cm, DROP mondial_relay_width_cm, DROP mondial_relay_height_cm, DROP mondial_relay_shipment_number, DROP mondial_relay_label_url');

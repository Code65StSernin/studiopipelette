 ...
 */
final class Version20260126122727 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD client_depot_vente TINYINT DEFAULT 0 NOT NULL, ADD image VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP client_depot_vente, DROP image');

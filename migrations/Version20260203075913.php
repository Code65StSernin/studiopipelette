 ...
 */
final class Version20260203075913 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE societe ADD enable_mondial_relay TINYINT DEFAULT 1 NOT NULL, ADD enable_lettre_suivie TINYINT DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE societe DROP enable_mondial_relay, DROP enable_lettre_suivie');

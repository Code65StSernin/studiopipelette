 ...
 */
final class Version20260126151718 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE depot_vente_categorie (depot_vente_id INT NOT NULL, categorie_id INT NOT NULL, INDEX IDX_3546A4ADBCF5E72D (categorie_id), INDEX IDX_3546A4ADFADC9094 (depot_vente_id), PRIMARY KEY (depot_vente_id, categorie_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_0900_ai_ci` ENGINE = MyISAM COMMENT = \'\' ');

 ...
 */
final class Version20260201123305 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE societe ADD pourcentage_urssaf_bic DOUBLE PRECISION DEFAULT NULL, ADD pourcentage_urssaf_bnc DOUBLE PRECISION DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE societe DROP pourcentage_urssaf_bic, DROP pourcentage_urssaf_bnc');

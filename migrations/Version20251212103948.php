 ...
 */
final class Version20251212103948 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sous_categorie (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('ALTER TABLE address ADD CONSTRAINT FK_D4E6F81A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE article ADD categorie_id INT NOT NULL, ADD sous_categorie_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_23A0E66365BF48 ON article (sous_categorie_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_23A0E66365BF48 ON article');
        $this->addSql('ALTER TABLE article DROP categorie_id, DROP sous_categorie_id');

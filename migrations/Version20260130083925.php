 ...
 */
final class Version20260130083925 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vente CHANGE mode_paiement mode_paiement VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vente CHANGE mode_paiement mode_paiement VARCHAR(20) NOT NULL');
    }
}

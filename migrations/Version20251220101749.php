 ...
 */
final class Version20251220101749 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article DROP informations_dimensions, DROP longueur_min, DROP longueur_max');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD informations_dimensions LONGTEXT DEFAULT NULL, ADD longueur_min INT DEFAULT NULL, ADD longueur_max INT DEFAULT NULL');

 ...
 */
final class Version20260130125255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bon_achat ADD client_id INT NOT NULL');
        $this->addSql('ALTER TABLE bon_achat ADD CONSTRAINT FK_5B8DF14A19EB6921 FOREIGN KEY (client_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_5B8DF14A19EB6921 ON bon_achat (client_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_5B8DF14A19EB6921 ON bon_achat');
        $this->addSql('ALTER TABLE bon_achat DROP client_id');

 ...
 */
final class Version20260130085412 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE paiement (id INT AUTO_INCREMENT NOT NULL, montant NUMERIC(10, 2) NOT NULL, methode VARCHAR(50) NOT NULL, date_paiement DATETIME NOT NULL, vente_id INT NOT NULL, INDEX IDX_B1DC7A1E7DC7170A (vente_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');

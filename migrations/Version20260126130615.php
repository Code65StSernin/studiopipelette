 ...
 */
final class Version20260126130615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sous_categorie_vente CHANGE sous_categorie_id categorie_stock_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX IDX_B1838AF0354A207A ON sous_categorie_vente (categorie_stock_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_B1838AF0354A207A ON sous_categorie_vente');
        $this->addSql('ALTER TABLE sous_categorie_vente CHANGE categorie_stock_id sous_categorie_id INT DEFAULT NULL');
